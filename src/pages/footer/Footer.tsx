...
export default function Footer() {
    ...
    return (
        <div className="container py-4" id="container">
            ...
            <hr className="border border-1 border-dark border-opacity-50" />
            ...
            <div className="d-flex gap-3" id="social">
                <span>
                    ...
                    >
                        <svg
                            aria-hidden="true"
                            className="vaspangn-middle absoluteCenter"
                            focusable="false"
                ...
                <span>
                    {/* facebook */}
                    <a href="https://facebook.com/starbucks" target="_blank">
                        <svg
                            aria-hidden="true"
                            className="vaspangn-middle absoluteCenter"
                            focusable="false"
                ...
                <span>
                    {/* instagram */}
                    <a href="https://instagram.com/starbucks" target="_blank">
                        <svg
                            aria-hidden="true"
                            className="vaspangn-middle absoluteCenter"
                            focusable="false"
                ...
                <span>
                    {/* twitter / x */}
                    <a href="https://x.com/starbucks/" target="_blank">
                        <svg
                            aria-hidden="true"
                            className="vaspangn-middle absoluteCenter"
                            focusable="false"
